...
const ENGLISH_MESSAGES: I18nMessages = {
  ...
  messages: {
    welcome: {
      title: (firstName: string) => `👋 Welcome to MultiCast Bot, ${firstName}!`,
      description: (userId: string) => `Your account has been created successfully.\n\n🆔 User ID: ${userId}`,
      features: "🚀 Features available to you:\n• 📢 Send messages to multiple channels\n• ➕ Add unlimited channels\n• 🌐 Multi-language support",
    },
    ...
    messages: {
      ...
      noMessagesDescription: "You haven't sent any messages yet. Start by adding channels and sending your first message!",
      historyTitle: "📜 Message History",
      historyLast: (count: number) => `📜 Message History (Last ${count})`,
      messagePreview: "📝 Message Preview:",
      confirmBroadcast: "📢 Confirm Broadcast",
      messageSentTo: (count: number) => `Your message will be sent to ${count} channel(s):`,
      confirmBroadcastQuestion: "Are you sure you want to broadcast this message?",
    },
    channels: {
      title: (count?: number) => count !== undefined ? `📋 My Channels (${count})` : "📋 My Channels",
      noChannels: "📭 No channels added yet",
      howToAdd: "How to add channels:",
      instructions: "1. Add the bot to your channel as admin\n2. The channel will appear here automatically\n3. Or manually add by username: @channel",
      ...
      addInstructions: {
        ...
        method2Format: "Send me the channel username in this format:\n@channelname",
        examples: "Examples:",
    ...
    broadcast: {
      ...
      inProgressDescription: "Please wait while we send your message to all channels.",
      ...
      failedChannelsNote: "💡 Failed channels may have restricted bot permissions or be inactive.",
      error: "❌ Error during broadcast. Some messages may not have been sent.",
      limitReached: "🚫 Message Limit Reached",
      yourUsage: "📊 Your Usage:",
      freeMessagesUsed: (used: number, total: number) => `• Free messages used: ${used}/${total}`,
      ...
      noActiveChannelsDescription: "You don't have any active channels where you can post messages.",
      ...
      activeChannelsReady: (count: number) => `You have ${count} active channel(s) ready for broadcasting:`,
      typeMessage: "📝 Please type your message that you want to send to all these channels:",
      tips: "💡 Tips:",
    ...
    channelManagement: {
      ...
      activated: (title: string) => `✅ Channel "${title}" has been activated and will receive broadcasts.`,
      deactivated: (title: string) => `🔴 Channel "${title}" has been deactivated and will not receive broadcasts.`,
      removeTitle: "🗑️ Remove Channel",
      removeConfirmation: "Are you sure you want to remove this channel?",
      removeWarning: "⚠️ This action cannot be undone. You'll need to add the channel again if you want to use it for broadcasting.",
    ...
    subscription: {
      ...
      subscriptionStatus: (status: string) => `• Subscription status: ${status}`,
      useCancelCommand: "Use /cancel_subscription if you want to cancel your subscription.",
      upgradeTitle: "💎 Upgrade to Premium",
      yourFreePlan: "🆓 Your Free Plan:",
      freeUsed: (used: number, total: number) => `• Free messages used: ${used}/${total}`,
      ...
      cancelConfirmation: "Are you sure you want to cancel your premium subscription?",
      willLose: "❌ You will lose:",
      willKeep: "✅ You will keep:",
      basicFunctionality: "• Basic functionality",
      dataAndChannels: "• Your data and channels",
      remainsActive: "Your subscription will remain active until the end of the current billing period.",
      ...
      cancelledMessage: "Your premium subscription has been cancelled and will end at the end of your current billing cycle.",
      returnToFreePlan: "🆓 After that, you'll return to the free plan with:",
      freeMessages: "• 3 free messages per month",
      keepChoice: "💎 Great choice! Your premium subscription will continue as normal. Thank you for staying with us!",
      noPremiumToCancel: "❌ You don't have an active premium subscription to cancel.",
    },
    general: {
      unknown: "Unknown",
      none: "None",
      ...
      accountSetupError: "❌ Sorry, there was an error setting up your account. Please try again later.",
      messageHistoryLegend: "✅ Sent  ❌ Failed  ⏳ Pending  📤 Scheduled",
      detailedMessagesHint: "Use /messages_detailed for more information about specific messages.",
      sent: "✅",
      failed: "❌",
      pending: "⏳",
      scheduled: "📤",
    ...
    channelAddition: {
      ...
      exampleGroup: "• @mygroup - for public groups",
      note: "Note: For private channels/groups, use Method 1 (auto-detection) by adding the bot directly.",
      alreadyInList: (title: string) => `✅ Channel "${title}" is already in your list!`,
      notFoundError: (username: string) => `❌ Channel @${username} not found or not accessible. Make sure:`,
      channelPublic: "• The channel is public",
      usernameCorrect: "• The username is correct",
      botHasAccess: "• The bot has access to the channel",
      foundButNotAdmin: (title: string) => `⚠️ Found channel "${title}", but the bot is not an admin.`,
      addAsAdmin: "Please add the bot as an administrator to this channel, then try again.",
...
const RUSSIAN_MESSAGES: I18nMessages = {
  ...
  messages: {
    welcome: {
      title: (firstName: string) => `👋 Добро пожаловать в MultiCast Bot, ${firstName}!`,
      description: (userId: string) => `Ваш аккаунт был успешно создан.\n\n🆔 ID пользователя: ${userId}`,
    ...
    profile: {
      ...
      connectedPlatforms: (count: number) => `🔗 Подключенные платформы: ${count}`,
      ...
      freePlan: (remaining: number) => `🆓 Бесплатный план (осталось ${remaining})`,
    },
    language: {
    ...
    messages: {
      ...
      noMessagesDescription: "Вы еще не отправили ни одного сообщения. Начните с добавления каналов и отправки первого сообщения!",
      historyTitle: "📜 История сообщений",
      historyLast: (count: number) => `📜 История сообщений (Последние ${count})`,
      messagePreview: "📝 Предварительный просмотр сообщения:",
      confirmBroadcast: "📢 Подтвердить рассылку",
      messageSentTo: (count: number) => `Ваше сообщение будет отправлено в ${count} канал(ов):`,
      confirmBroadcastQuestion: "Вы уверены, что хотите отправить это сообщение?",
    },
    channels: {
      title: (count?: number) => count !== undefined ? `📋 Мои каналы (${count})` : "📋 Мои каналы",
      noChannels: "📭 Каналы еще не добавлены",
      howToAdd: "Как добавить каналы:",
      instructions: "1. Добавьте бота в ваш канал как администратора\n2. Канал появится здесь автоматически\n3. Или добавьте вручную по имени: @channel",
      ...
      addInstructions: {
        ...
        method2Format: "Отправьте мне имя пользователя канала в этом формате:\n@channelname",
        examples: "Примеры:",
    ...
    broadcast: {
      ...
      inProgressDescription: "Пожалуйста, подождите, пока мы отправляем ваше сообщение во все каналы.",
      ...
      failedChannelsNote: "💡 Неудачные каналы могут иметь ограничения на права бота или быть неактивными.",
      error: "❌ Ошибка при рассылке. Некоторые сообщения не могли быть отправлены.",
      limitReached: "🚫 Достигнут лимит сообщений",
      yourUsage: "📊 Ваше использование:",
      freeMessagesUsed: (used: number, total: number) => `• Использовано бесплатных сообщений: ${used}/${total}`,
      totalMessagesSent: (count: number) => `• Всего отправлено сообщений: ${count}`,
      ...
      noActiveChannelsDescription: "У вас нет активных каналов, где вы можете отправлять сообщения.",
      ...
      activateChannelsStep: "3️⃣ Активировать каналы, которые хотите использовать",
      manageChannelsHint: 'Используйте "📋 Мои каналы" для управления каналами.',
      broadcastTitle: "📢 Рассылка сообщения",
      activeChannelsReady: (count: number) => `У вас есть ${count} активных канала(ов) готовых для рассылки:`,
      typeMessage: "📝 Пожалуйста, введите сообщение, которое хотите отправить во все эти каналы:",
      tips: "💡 Советы:",
    ...
    channelManagement: {
      ...
      activated: (title: string) => `✅ Канал "${title}" был активирован и будет получать рассылки.`,
      deactivated: (title: string) => `🔴 Канал "${title}" был деактивирован и не будет получать рассылки.`,
      removeTitle: "🗑️ Удалить канал",
      removeConfirmation: "Вы уверены, что хотите удалить этот канал?",
      removeWarning: "⚠️ Это действие нельзя отменить. Вам нужно будет добавить канал снова, если захотите использовать его для рассылки.",
    ...
    subscription: {
      ...
      totalMessages: (count: number) => `• Всего отправлено сообщений: ${count}`,
      subscriptionStatus: (status: string) => `• Статус подписки: ${status}`,
      useCancelCommand: "Используйте /cancel_subscription, если хотите отменить подписку.",
      upgradeTitle: "💎 Обновиться до Премиум",
      yourFreePlan: "🆓 Ваш бесплатный план:",
      freeUsed: (used: number, total: number) => `• Использовано бесплатных сообщений: ${used}/${total}`,
      ...
      remainsActive: "Ваша подписка останется активной до конца текущего биллингового периода.",
      ...
      cancelledMessage: "Ваша премиум подписка была отменена и закончится в конце текущего биллингового цикла.",
      returnToFreePlan: "🆓 После этого вы вернетесь к бесплатному плану с:",
      freeMessages: "• 3 бесплатных сообщения в месяц",
      keepChoice: "💎 Отличный выбор! Ваша премиум подписка будет продолжена как обычно. Спасибо, что остаетесь с нами!",
    ...
    general: {
      ...
      accountSetupError: "❌ Извините, произошла ошибка при настройке вашего аккаунта. Пожалуйста, попробуйте позже.",
      messageHistoryLegend: "✅ Отправлено  ❌ Не удалось  ⏳ В ожидании  📤 Запланировано",
      detailedMessagesHint: "Используйте /messages_detailed для получения дополнительной информации о конкретных сообщениях.",
      sent: "✅",
      failed: "❌",
      pending: "⏳",
      scheduled: "📤",
    ...
    channelAddition: {
      ...
      manualDescription: "Отправьте мне имя пользователя канала в этом формате:",
      examples: "Примеры:",
      exampleChannel: "• @mychannel - для публичных каналов",
      exampleGroup: "• @mygroup - для публичных групп",
      note: "Примечание: Для приватных каналов/групп используйте Метод 1 (автообнаружение), добавив бота напрямую.",
      alreadyInList: (title: string) => `✅ Канал "${title}" уже в вашем списке!`,
      notFoundError: (username: string) => `❌ Канал @${username} не найден или недоступен. Убедитесь, что:`,
      channelPublic: "• Канал публичный",
      usernameCorrect: "• Имя пользователя правильное",
      botHasAccess: "• У бота есть доступ к каналу",
      foundButNotAdmin: (title: string) => `⚠️ Найден канал "${title}", но бот не является администратором.`,
      addAsAdmin: "Пожалуйста, добавьте бота как администратора в этот канал, затем попробуйте снова.",
